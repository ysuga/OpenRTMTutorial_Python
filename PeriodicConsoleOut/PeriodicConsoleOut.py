...
def PeriodicConsoleOutInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=periodicconsoleout_spec)
    manager.registerFactory(profile,
                            PeriodicConsoleOut,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    PeriodicConsoleOutInit(manager)

    # Create a component
    comp = manager.createComponent("PeriodicConsoleOut")
